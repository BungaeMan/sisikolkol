            ...
            <SafeAreaView>
                ...
                <View style={{width: windowWidth - 36, alignSelf: 'center'}}>
                    <View style={{marginTop: 28, marginLeft: 12}}>
                        ...
                        <Text style={{opacity: 0.3, fontSize: 10, fontWeight: 400, marginTop: 3}}>예약 정보를 관리해보세요.</Text>
                    </View>
                    <Pressable
                        onPress={() => {
                        ...
                        <View>
                            <Text style={{fontSize: 10, opacity: 0.5, fontWeight: 500, textAlign: 'center'}}>예약된 정보가
                                없습니다.</Text>
                            <View style={{
                                flexDirection: 'row',
                                alignItems: 'center',
                    ...
                    {/*주류픽!*/}
                    <View style={{marginTop: 85, marginLeft: 12}}>
                        <Text style={{color: colors.darkGrey, fontSize: 16, fontWeight: 700}}>오늘의 주류 PICK</Text>
                        <Text style={{opacity: 0.3, fontSize: 10, fontWeight: 400, marginTop: 3}}>다양한 주류를 만나보세요.</Text>
                    </View>
